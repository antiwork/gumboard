...
export function Note({
  ...
  return (
    <div
      className={cn(
        "p-4 shadow-md shadow-black/10 rounded-lg select-none group transition-all duration-200 flex flex-col border border-gray-200 dark:border-gray-600 box-border",
        className
      )}
