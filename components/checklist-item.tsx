...
/** Autosize with a minimum of one line (line-height + vertical padding). */
const useAutosize = (
  enabled: boolean,
  ...
  React.useLayoutEffect(() => {
    ...
    // Prevent scrollbar flicker affecting measurements
...
export function ChecklistItem({
  ...
  return (
    <div
      className={cn(
        // Avoid transitioning height: only colors/transform
