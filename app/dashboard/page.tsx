            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 sm:gap-6">
              ...
              {boards.map((board) => (
                <Link href={`/boards/${board.id}`} key={board.id}>
                  <Card data-board-id={board.id} className="group hover:shadow-lg transition-shadow cursor-pointer bg-white dark:bg-zinc-900 border-gray-200 dark:border-zinc-800">
                    <CardHeader>
