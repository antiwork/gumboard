...
test.describe("Note Management", () => {
  test("should create a note and add checklist items", async ({
    ...
    // Wait for the content to appear in the UI
  ...
  test.describe("Text Overflow and Card Expansion", () => {
    test("should handle long text without overflow and expand card height", async ({
      ...
      const longTextWithoutSpaces =
        "ThisIsAVeryLongWordWithoutAnySpacesOrBreaksToTestHowTheApplicationHandlesTextOverflowWhenUsersTypeExtremelylongContinuousStringsWithoutAnyNaturalBreakPointsInTheUserInterface";
